...
int menu(void)				// Меню
{
	...
	cout << "3. Удаление k элементов" << endl;
	cout << "4. Запись элемента в файл" << endl;
	cout << "5. Считывание элемента из файла" << endl;
...
//-----------------------------------------------------------------------------
void deleteKFirst(Address** phead, int k)  //удаление k элементов 
{
	struct Address* t = *phead;
	if (*phead)
	{
...
int main(void)
{
	...
	while (true)
	{
		...
		case 3: 
		{
			...
			break;
		case 4:writeToFile(&head); break;
		case 5:readFromFile(&head, &last);break;
		case 6:outputList(&head, &last);break;
		case 7: 
		{	  
